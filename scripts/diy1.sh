...
wget https://github.com/kkstone/Actions-RAX3000M-NAND-EMMC/raw/main/luci-packages/luci-app-frp.zip
unzip luci-app-frp.zip && rm -rf luci-app-frp.zip
wget https://github.com/kkstone/Actions-RAX3000M-NAND-EMMC/raw/main/luci-packages/luci-app-wolplus.zip
